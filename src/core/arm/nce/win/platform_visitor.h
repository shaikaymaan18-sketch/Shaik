...
public:
    ...
    bool ADR(Imm<2> immlo, Imm<19> immhi, Reg Rd) {
        ChooseScratch(Reg::X18, Rd);
        return false || Rd == Reg::X18;
    }
    ...
    bool ADDG(Imm<6> offset_imm, Imm<4> tag_offset, Reg Rn, Reg Rd) {
        ChooseScratch(Reg::X18, Rn, Rd);
        return false || Rn == Reg::X18 || Rd == Reg::X18;
    }
    ...
    bool EXTR(bool sf, bool N, Reg Rm, Imm<6> imms, Reg Rn, Reg Rd) {
        ChooseScratch(Reg::X18, Rn, Rd, Rm);
        return false || Rn == Reg::X18 || Rd == Reg::X18 || Rm == Reg::X18;
    }
    ...
    bool SYS(Imm<3> op1, Imm<4> CRn, Imm<4> CRm, Imm<3> op2, Reg Rt) {
        ChooseScratch(Reg::X18, Rt);
        return false || Rt == Reg::X18;
    }
    ...
    bool RMIF(Imm<6> lsb, Reg Rn, Imm<4> mask) {
        ChooseScratch(Reg::X18, Rn);
        return false || Rn == Reg::X18;
    }
    ...
    bool BRA(bool Z, bool M, Reg Rn, Reg Rm) {
        ChooseScratch(Reg::X18, Rn, Rm);
        return false || Rn == Reg::X18 || Rm == Reg::X18;
    }
    ...
    bool STXR(Imm<2> size, Reg Rs, Reg Rn, Reg Rt) {
        ChooseScratch(Reg::X18, Rn, Rt, Rs);
        return false || Rn == Reg::X18 || Rt == Reg::X18 || Rs == Reg::X18;
    }
    ...
    bool LDXR(Imm<2> size, Reg Rn, Reg Rt) {
        ChooseScratch(Reg::X18, Rn, Rt);
        return false || Rn == Reg::X18 || Rt == Reg::X18;
    }
    ...
    bool STRx_reg(Imm<2> size, Imm<1> opc_1, Reg Rm, Imm<3> option, bool S, Reg Rn, Reg Rt) {
        ChooseScratch(Reg::X18, Rn, Rt, Rm);
        return false || Rn == Reg::X18 || Rt == Reg::X18 || Rm == Reg::X18;
    }
    ...
    bool MADD(bool sf, Reg Rm, Reg Ra, Reg Rn, Reg Rd) {
        ChooseScratch(Reg::X18, Rn, Rd, Rm, Ra);
        return false || Rn == Reg::X18 || Rd == Reg::X18 || Rm == Reg::X18 || Ra == Reg::X18;
    }
