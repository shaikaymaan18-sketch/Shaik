...
enum class BooleanSetting(override val key: String) : AbstractBooleanSetting {
    ...
    GPU_COMPUTE_UNSWIZZLE_2D("gpu_compute_unswizzle_2d"),
    GPU_COMPUTE_UNSWIZZLE_3D("gpu_compute_unswizzle_3d"),
    GPU_COMPUTE_UNSWIZZLE_PITCH("gpu_compute_unswizzle_pitch"),
